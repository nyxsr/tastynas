            ...
            <div class="page-content">
                ...
                <section class="best-section container mb-10 pb-10 appear-animate">
                    ...
                    <h2 class="title title-underline underline-center text-center with-double mt-4 mb-10">
                        <span class="pb-8">Best Selling Product</span>
                        <label class="title-duplex">Best Selling Product</label>
                    </h2>
                    <div class="owl-carousel owl-theme row cols-md-3 cols-sm-2 cols-1  mb-10 pb-9" data-owl-options="{
                                        'nav': false,
                                        'dots': false,
                                        'loop': false,
                                        'margin': 30,
                    ...
                    <div class="row pt-1 pb-1 appear-animate">
                        <div class="col-lg-4">
                            <figure class="leaf1 floating" data-floating-depth="1.5">
                                <img class="layer" src="images/demos/demo8/icon-box/leaf1.png" width="93" height="182"
                                    alt="leaf img" />
                            </figure>
                            <div class="icon-box text-center">
                                <figure class="icon-box-icon">
                                    <img src="images/demos/demo8/icon-box/icon1.png" width="69" height="47"
                                        alt="curve" />
                                </figure>
                            ...
                            <figure class="curve1 d-lg-show">
                                <img src="images/demos/demo8/icon-box/curve.png" width="190" height="32"
                                    alt="icon image" />
                            </figure>
                        </div>
                        <div class="col-lg-4">
                            <div class="icon-box text-center">
                                <figure class="icon-box-icon">
                                    <img src="images/demos/demo8/icon-box/icon2.png" width="64" height="64"
                                        alt="icon image" />
                                </figure>
                                <div class="icon-box-content">
                                    <h4 class="icon-box-title">Quality Guaranted</h4>
                                    <p>We offer high quality of products</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <figure class="curve2 d-lg-show">
                                <img src="images/demos/demo8/icon-box/curve.png" width="190" height="32"
                                    alt="icon image" />
                            </figure>
                            <div class="icon-box text-center">
                                <figure class="icon-box-icon">
                                    <img src="images/demos/demo8/icon-box/icon3.png" width="66" height="50"
                                        alt="icon image" />
                                </figure>
                                <div class="icon-box-content">
                            ...
                            <figure class="leaf2 floating" data-floating-depth="1.5"
                                data-options='{"invertX":false,"invertY":false}'>
                                <img class="layer" src="images/demos/demo8/icon-box/leaf2.png" width="89" height="190"
                                    alt="leaf img" />
                            </figure>
                        </div>
                    </div>
