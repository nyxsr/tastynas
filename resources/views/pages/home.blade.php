...
<main class="main">
    <div class="page-content">
        ...
        <div class="container mt-10 mb-10 pb-7">
            ...
            <div class="owl-carousel owl-theme owl-nav-box row cols-1 appear-animate" data-owl-options="{
                            'items': 1,
                            'nav': false,
                            'dots': false,
                            'autoplay': true,
                ...
                <div class="testimonial testimonial-centered with-double-quote">
                    <blockquote>
                        <figure class="testimonial-author-thumbnail">
                            <img src="{{ asset('assets/images/testimoni/3cropped.png') }}" alt="user" width="120"
                                height="120" />
                        </figure>
                ...
                <div class="testimonial testimonial-centered with-double-quote">
                    <blockquote class="text-body">
                        <figure class="testimonial-author-thumbnail">
                            <img src="{{ asset('assets/images/testimoni/2cropped.png') }}" alt="user" width="120"
                                height="120" />
                        </figure>
                        <p class="mb-3">“Pas cobain Nastar Tugu Nanas, Baru ujungnya udah enak banget, apalagi tengahnya. Teksturnya juga lembut, banyak banget isiannya. Enak bangettt”</p>
                        <div class="testimonial-info">
                            <cite>
                                Agung Setyadi
                                <span class="text-body">Customer</span>
                ...
                <div class="testimonial testimonial-centered with-double-quote">
                    <blockquote class="text-body">
                        <figure class="testimonial-author-thumbnail">
                            <img src="{{ asset('assets/images/testimoni/5cropped.png') }}" alt="user" width="120"
                                height="120" />
                        </figure>
                        <p class="mb-3">“Seger banget! Nanasnya pas, manisnya pas seger banget, gak akan gagal deh. Ini salah satu produk minuman ter-enak. Masya Allah mantap!”</p>
                        <div class="testimonial-info">
                            <cite>
                                Ibu Thianu
                                <span class="text-body">Customer</span>
                ...
                <div class="testimonial testimonial-centered with-double-quote">
                    <blockquote class="text-body">
                        <figure class="testimonial-author-thumbnail">
                            <img src="{{ asset('assets/images/testimoni/6cropped.png') }}" alt="user" width="120"
                                height="120" />
                        </figure>
                        <p class="mb-3">“Wah, pie nya gede banget isinya juga banyak. Ada potongan nanasnya juga, jadi ngga terlalu lembek. Enak !! Harus Cobain recommended banget.”</p>
                        <div class="testimonial-info">
                            <cite>
                                Fitri Goes
                                <span class="text-body">Customer</span>
        ...
        <hr class="underline-divider" style="margin-top:-3rem">
            ...
            <div style="margin-bottom:10rem" class="owl-carousel owl-theme row cols-lg-3 cols-md-2 cols-1" data-owl-options="{
                            'items': 3,
                            'margin': 20,
                            'loop': false,
                            'nav': false,
                ...
                <div class="post overlay-zoom overlay-dark">
                    <figure class="post-media">
                        <a href="blog-single.html">
                            <img src="{{ asset('assets/images/pemberdayaan/20200519_115531.jpg') }}" width="400" height="260" alt="post" />
                        </a>
                    </figure>
                    <div class="post-details">
                        ...
                        <div class="post-meta"><img src="assets/images/croppedPeople.jpg" class="post-agent" width="31"
                                height="31" alt="agent">By
                        ...
                        <p class="post-content">Sebagai Brand Lokal Pelopor Kuliner Olahan Buah Nanas yang bercitarasa eksklusif & modern, kami berkomitmen untuk selalu memilih bahan baku utama yang terbaik bagi aneka produk yang kami produksi, termasuk kualitas dari buah nanas itu sendiri. Sekitar 3 sampai 5 ton per bulannya jumlah buah Nanas yang di supply oleh petani nanas Subang untuk memenuhi kebutuhan dapur produksi kami.</p><a href="blog-single.html" class="text-secondary">(read more)</a>
                    </div>
                </div>
                <div class="post overlay-zoom overlay-dark">
                    <figure class="post-media">
                        <a href="blog-single.html">
                            <img src="{{ asset('assets/images/support-event/23.png') }}" width="400" height="260" alt="post" />
                        </a>
                    </figure>
                    <div class="post-details">
                        ...
                        <p class="post-content">Delipel – Tastynas pun tidak jarang untuk diminta sebagai salah satu support event dalam berbagai kesempatan acara di bidang Pendidikan baik itu berupa event seminar, workshop, dan event lainnya yang diselenggarakan di Kabupaten Subang.</p><a href="blog-single.html" class="text-secondary">(read more)</a>
                    </div>
                </div>
                <div class="post overlay-zoom overlay-dark">
                    <figure class="post-media">
                        <a href="blog-single.html">
                            <img src="{{ asset('assets/images/csr/IMG-20220210-WA0024.jpg') }}" width="400" height="260" alt="post" />
                        </a>
                    </figure>
                    <div class="post-details">
                        <p class="post-cats"><a href="blog.html">Tastynas</a>,<a href="blog.html">Subang</a>
                        </p>
                        <h3 class="post-title"><a href="blog-single.html">Program CSR (Corporate Social Responsibility)</a>
                        </h3>
                        <div class="post-meta"><img src="assets/images/croppedPeople.jpg" class="post-agent" width="31"
                                height="31" alt="agent">By
                            <a href="blog.html" class="post-author">Ahmad</a>
                        ...
                        <p class="post-content">Kami sebagai UKM Pelopor Bakery Olahan Nanas Subang selalu mengadakan program CSR dengan pembagian Milky Juice Nanas ataupun aneka produk lainnya kepada masyarakat sekitar ataupun kepada institusi di bidang kesehatan serta keamanan. Milky Juice Nanas yang terbuat dari sari buah Nanas asli dan diolah secara higienis ini menjadi asupan vitamin C alami bagi tubuh. Sehingga kesegaran alamiah yang akan sahabat dapatkan dari mengkonsumsi Milky Juice Nanas kami ini.
                            Semoga keberadaan kami sampai dengan saat ini & pada waktu-waktu mendatang, dapat terus berkontribusi untuk Kota Subang tercinta. Walau mungkin partisipasi & peran kami ini masih bergerak menapaki setahap demi setahap. Tetapi kami sangat menikmati setiap proses yang kami lalui sampai dengan saat ini.</p><a href="blog-single.html" class="text-secondary">(read more)</a>
                    </div>
                </div>
            </div>
        </div>
