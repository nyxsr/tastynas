...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Testimoni/ Kelola Testimoni/</span> Tambah Data</h4>
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Tambah Data Testimoni</h5>
          </div>
          <div class="card-body">
            <form action="{{ route('kelolaTestimoni.store') }}" method="post" enctype="multipart/form-data">
                @method('post')
                @csrf
              <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-12">
                  <div class="input-group input-group-merge">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="isi_review">{{ old('isi_review') }}</textarea>
                  </div>
                </div>
              </div>
              <div class="row mb-3">
