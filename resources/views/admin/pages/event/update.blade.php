...
@section('main')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Event/ <a href="{{ url('kelolaEvent') }}"> Kelola
                    Event</a>/</span> Update Data</h4>
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Update Data Event</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('kelolaEvent.update', $event->id) }}" method="post"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            ...
                                            name="link_event" value="{{ $event->link_event }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
