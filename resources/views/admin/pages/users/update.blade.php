...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users/ <a href="{{ url('kelolaUser') }}"> Kelola Users</a>/</span> Update Data</h4>
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Update Data User</h5>
          </div>
          <div class="card-body">
            <form action="{{ route('kelolaUser.update', $user->id) }}" method="post" enctype="multipart/form-data">
                @method('put')
                @csrf
              <div class="row mb-3">
