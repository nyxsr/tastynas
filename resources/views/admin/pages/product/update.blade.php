            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Update Data Produk</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('kelolaProduk.update', $prod->id) }}" method="post"
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" id="basic-icon-default-fullname"
                                            ...
                                            name="nama_produk" value="{{ $prod->nama_produk }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" id="exampleFormControlSelect1"
                                        ...
                                        @forelse ($kategori as $cat)
                                            <option value="{{ $cat->id }}"
                                                @if ($cat->id == $prod->category->id) selected @endif>{{ $cat->nama_kategori }}
                                            </option>
                                        @empty
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="harga" class="form-control"
                                            placeholder="format:000000(tanpa titik/koma)" name="harga"
                                            value="{{ $prod->harga }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <textarea name="deskripsi" class="form-control" id="exampleFormControlTextarea1" rows="3">{{ $prod->deskripsi }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
