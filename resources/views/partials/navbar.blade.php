        ...
        <div class="container">
            ...
            <div class="header-right">
                ...
                <div class="social-links">
                    ...
                    <a href="#" title="Twitter" class="social-link fa-brands fa-instagram"></a>
                    <a href="#" title="Pinterest" class="social-link fa-brands fa-tiktok"></a>
                    <a href="#" title="Linkedin" class="social-link fa-brands fa-youtube"></a>
                </div>
                <!-- End of Social Links -->
            </div>
        </div>
                                            ...
                                            <form action="#">
                                                <div class="form-group mb-4">
                                                    <input type="text" class="form-control" id="register-user"
                                                        name="register-user" placeholder="Username" required="">
                                                </div>
                                                <div class="form-group mb-4">
